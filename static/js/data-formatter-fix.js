...
if (window.dataFormatterFixesInitialized) {
  console.log('[DataFormatter] Fixes already initialized, skipping duplicate initialization');
} else {
  window.dataFormatterFixesInitialized = true;
