 ...
 * 
 * Usage: node generate_phoenix_data_node.js [number_of_incidents]
 */

const fs = require('fs');
const path = require('path');

// Command line argument for number of incidents
const args = process.argv.slice(2);
const INCIDENTS_TO_GENERATE = args[0] ? parseInt(args[0]) : 5000;

// Constants and configuration
const OUTPUT_FILE = path.join(__dirname, '../data/incidents/phoenix_motorola_cad_incidents.csv');
...
// Run the generator and write to file
console.log(`Starting generation of ${INCIDENTS_TO_GENERATE} Phoenix Fire Department incidents...`);
...
fs.writeFileSync(OUTPUT_FILE, result.csv);
