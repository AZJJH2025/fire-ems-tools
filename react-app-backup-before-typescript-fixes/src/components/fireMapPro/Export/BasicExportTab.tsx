...
import { ExportConfiguration, ExportFormat, DPIResolution, PaperSize, PrintOrientation } from '@/types/export';
    ...
    if (settings.title) {
      if (!titleElement) {
        ...
        dispatch(updateLayoutElement({
          id: titleElement.id,
          content: { ...titleElement.content, text: settings.title }
        }));
      }
    }
    ...
    if (settings.subtitle) {
      if (!subtitleElement) {
        ...
        dispatch(updateLayoutElement({
          ...
          content: { ...subtitleElement.content, text: settings.subtitle }
        }));
      }
    }
  };
