...
if (window.dataFormatterIntegrationInitialized) {
  console.log('[DataFormatter] Integration already initialized, skipping duplicate initialization');
} else {
  window.dataFormatterIntegrationInitialized = true;
