/**
 * FireEMS.ai Incident Logger - CAD Integration Module (Fixed Version)
 * 
...
window.IncidentLogger.Components.CAD = window.IncidentLogger.Components.CAD || {};
...
window.IncidentLogger.Components.CAD = {
    importData: importCadData,
    applyToIncident: applyCadToIncident,
    createImportUI: createCadImportUI
};

// Add global functions for backward compatibility
window.importCadData = importCadData;
window.applyCadToIncident = applyCadToIncident;
window.createCadImportUI = createCadImportUI;

console.log("CAD Integration component loaded (fixed version)");