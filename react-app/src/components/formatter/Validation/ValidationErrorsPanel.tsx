...
const ValidationErrorsPanel: React.FC<ValidationErrorsPanelProps> = ({ 
  ...
  // const errorsByField = groupErrorsByField(errors); // Reserved for future field grouping feature
                        ...
                        secondaryAction={
                          error.rowIndex !== undefined && onJumpToError && (
                            <Button 
                              size="small" 
                              variant="outlined"
                              onClick={() => error.rowIndex !== undefined && onJumpToError(error.rowIndex, error.field)}
                            >
                              Jump to Row
                            </Button>
                          )
