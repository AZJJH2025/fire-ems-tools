  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Tab label="Basic" id="export-tab-0" aria-controls="export-tabpanel-0" disabled={process.isExporting} />
          <Tab label="Advanced" id="export-tab-1" aria-controls="export-tabpanel-1" disabled={process.isExporting} />
          <Tab label="Layout Designer" id="export-tab-2" aria-controls="export-tabpanel-2" disabled={process.isExporting} />
        </Tabs>
      </DialogTitle>
